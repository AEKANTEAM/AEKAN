...
usertext = '\n👤| العضو » ['..result.title_..'](t.me/'..(username or 'A7KAN')..')'
...
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'A7KAN')..')'
status  = '\n🔘| تم ترقيته مطور في البوت'
...
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/A7KAN)}\n📛¦["..BOYKA_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠|عذرا يا » {["..data.first_name_.."](T.ME/A7KAN)}\n📮| الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'A7KAN')..') \n🔘| تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'A7KAN')..') \n🔘| تـم قفـل التاك بالكتم ')  
end,nil)   
...
------------------------------------------------------------------------
if text == 'تنزيل البكلبي' and Mod(msg) then
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '🗑| تم تنزيل جميع اللي بكلبك بالمجموعه  ')
end
if text == ("تاك لبكلبي") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n🔘| قائمة الاعضاء داخل كلبك \nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'A7KAN')..')'
local  statuss  = '\n🔘| ⚡| تم رفع العضو داخل كلبك\n  تعال حبي يكلبي ونبضاته'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل التيجان' and Mod(msg) then
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '🗑| تم تنزيل جميع التيجان بالمجموعه  ')
end
if text == ("تاك للتيجان") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n🔘| قائمة الاعضاء تيجان المجموعه \nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '🗑| تم تنزيل جميع المتزوجات بالمجموعه  ')
end
if text == ("تاك للمتزوجات") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n🔘| قائمة الاعضاء المتزوجات بالمجموعه \nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← مرتي [@"..username.."]\n"
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'A7KAN')..')'
local  statuss  = '\n🔘| ⚡| تم رفع العضو مرتي\n  أصبحت زوجتك الشخصيه والاعضاء شهود'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'A7KAN')..')'
status  = '\n⚡| تم تنزيل العضو مرتي \nانتي طالق وأعضاء المجموعه شهود'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل الكبلات' and Mod(msg) then
database:del(bot_id..'Motee:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '🗑| تم تنزيل جميع الكبلات بالمجموعه  ')
end
if text == ("تاك للكبلات") and Mod(msg) then
local list = database:smembers(bot_id..'Motee:User'..msg.chat_id_)
t = "\n🔘| قائمة الاعضاء الكبلات بالمجموعه \nء┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."← كبل [@"..username.."]\n"
...
if #list == 0 then
t = "⚠️| لا يوجد عضو مكبل"
end
send(msg.chat_id_, msg.id_, t)
end
---------
if text == ("رفع كبل") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'A7KAN')..')'
local  statuss  = '\n🔘| ⚡| تم رفع العضو كبل\n أصبح حبيبك الشخصي والاعضاء شهود'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل كبل")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤| العضو » ['..result.title_..'](t.me/'..(text1[3] or 'A7KAN')..')'..'\n🔘| تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
'كول يعطري ❣️ اني '..Namebot..'',
'نعم شتريد حبي 😍 اني '..Namebot..'',
...
if text == "منو حبيبج" or text == "حبيبج" or text == "تحبين منو" or text == "منو قلبك" or text == "منو حبك" or text == "منو عشقك" or text == "منو حياتك" or text == "منو نبضك" or text == "نبضك" or text == "عشقك" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ايكان تاج 👑 راسك","ايكون حبيبي فديته 💋❤️ ","ايكان گلبي ودگاته","ايكان حبي الابدي","ايكان فديته ناني","ايكان فدوه لعمره ناني","ايكان نبضي ❤️ بس"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "منو حبيبتج" or text == "حبيبتج" or text == "عشقج" or text == "منو حبج" or text == "نبضج" or text == "منو عشقج" or text == "منو نبضج" or text == "منو قلبج" or text == "منو حياتج" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"رهوفتي العشق","رهف نبضي وكل هلي ","رهف گلبي ودگاته","رهف حبي الابدي","رهف فديتها ناني","رهف فدوه لعمرها ناني","رهف نبضي ❤️ وحياتي"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "المهم" or text == "الاهم" or text == "شوف المهم" or text == "مهم" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"اكو اهم","ركزلي ع الاهم "لا شيء","مين حفلتي اليوم هخخخخخخخخخخخ","قصدي شآطرهه**ههههههههههههههههههههههههههههه" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "المهم شتردين" or text == "شتردين" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ما اريد شي سلامتك","أحبك وموت عليك ليش تكسر كلبي" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "المهم شتريد" or text == "شتريد" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"اريد اكولج احبج ادري بيج سهرانه","سلامتك خبي"," عود أحبك" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "تسلمين غلاي" or text == "تسلمين يالاخت" or text == "تسلم يالاخو" or text == "تسلمين" or text == "تسلم" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"يسلمك/ج ربي","الله يسلمك/ج ","ولو عمري","يتللوووو عنوناتي"," ولو كلبي" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "رئتاي" or text == "رئتيني" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"طلعة محروكة الصفحه مدفيه على تاير امشعوط وخنكتني ابريحتها.","نفسها"," هواها" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "حبي" or text == "حياتي" or text == "كبدي" or text == "تسلمين" or text == "قلبي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"طحالي","سلامتك يعورك من الحب صح ","اموت ﻋﻠﻴﻚ"," عنوناتي"," وتيني" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "بعد روحي" or text == "بعد عمري" or text == "عيوني" or text == "عيناي" or text == "بعد عيوني" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"عيوني وقلبي وحياتي انااا","بعد روحي 🌹 ","ماشوف بعيوني"," اي عمري"," اوكسجيني" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "كلبي انتي" or text == "كلبي انته" or text == "كلبي" or text == "قلبوشي" or text == "قلبي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"فدوه الكلبك/ج","حبي انته","اموت ع كلبج/ك"," اي تلبه"," يا روحي" }
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
