...
send(chat,msg.id_,"❦⦚ ملف النسخه ليس لهاذا البوت")   
return false 
end      
...
if SudoBot(msg) then
local bl = '❦⦚ اهلا عزيزي المـطـور\n❦⦚ آنت آلمـطـور آلآسـآسـي للبوت\n⏦Ⓐ⓷ⓀⓄⓃ ❦ ⓇⓉ⊝ⓎⓉ⏦\n❦⦚ تسـتطـيع‌‏ التحكم بأوامر البوت\n❦⦚ من خلاال الكيبورد الخاص بك\n❦⦚ قناة سورس البوت [اضغط هنا](t.me/SoalfLove)'
local keyboard = {
{'الاحصائيات 𖡬'},
...
{'تفعيل البوت الخدمي 𖤴','تعطيل البوت الخدمي ℘'},
...
Text = '❦⦚ عدد النقود التي ربحتها هي *» { '..Num..' } نقوده *'
end
send(msg.chat_id_, msg.id_,Text) 
end
