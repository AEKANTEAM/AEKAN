...
AEKAN_Msg = 'متفاعل قوي😍✔️' 
elseif msgs < 2000 then 
AEKAN_Msg = 'متفاعل جدا😍💘' 
elseif msgs < 3500 then 
AEKAN_Msg = 'اقوى تفاعل🙊👻'  
elseif msgs < 4000 then 
AEKAN_Msg = 'متفاعل نار😍🔥' 
elseif msgs < 4500 then 
AEKAN_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
AEKAN_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
AEKAN_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
AEKAN_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
AEKAN_Msg = 'رب التفاعل✔️😍'  
end 
return AEKAN_Msg 
end
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local AEKAN1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..AEKAN1.server.uptime_in_days..'('..AEKAN1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..AEKAN1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..AEKAN1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..AEKAN1.stats.instantaneous_ops_per_sec..'`\n'
...
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","خرب الله","كسخواتكم","كحاب","نيجه","نيجج","كحوبه","عيري","مشتهيه","نيج","انيجك","انيجج","كواده","طيزج","كسج","مناويج","منيجه","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك"}
for k,v in pairs(list) do
...
list = {"ڄ","گ","که","پی","خسته","برم","راحتی","بیام","دوستان","شادی","بپوشم","گرمه","چه","اخ کیر","زیباترین","میخام","خوبم","تو فق","زیباتون","دوستان","خوشکلم","ای","ازش","جانمونی","ریتم","نیاری","ملایم","داداش","بیا","باشم","میخوای","تندتر","ریتمو","زیرت","بکشی","کنی","اومدم","شه","خوب","هست","کسی","دستم","صبجتون","کیر","چ","ڬ","ٺ","چ","ڇ","ڿ","ڀ","ڎ","ݫ","ژ","ڟ","ݜ","ڸ","پ","۴","زدن","دخترا","دیوث","مک","زدن"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
return false
