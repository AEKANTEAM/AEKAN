...
if text == ("قائمه كتم عام") and SudoBot(msg) then
...
if text == ("كتم عام") and tonumber(msg.reply_to_message_id_) ~= 0 and SudoBot(msg) then
function Function_AEKAN(extra, result, success)
if result.sender_user_id_ == tonumber(Id_Sudo) then
send(msg.chat_id_, msg.id_, "♡∶ لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور البوت الاساسي \n")
return false 
...
if (text == ("تنزيل مميز")) and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if AEKANrt == "مميز" and Mod(msg) then
...
database:set(bot_id.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,RTPA)  
database:sadd(bot_id.."Manager"..msg.chat_id_,result.sender_user_id_)  
elseif AEKANrt == "عضو" and Mod(msg) then
send(msg.chat_id_, msg.id_,"♡∶ العضو ⤙ ["..data.first_name_.."](t.me/"..(data.username_ or "SoalfLove")..")".."\n♡∶ تم رفعه "..RTPA.." هنا\n")
end
end,nil)   
end   
...
if text == "هينه" or text == "هينها" and msg.reply_to_message_id_ ~= 0 and Mod(msg) then
...
if text == ("الغاء كتم") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == ("تقيد") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
------------------------------------------------------------------------
if text == ("الغاء تقيد") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيل مشرف")) and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^وضع تكرار (%d+)$") and Mod(msg) then   
local Num = text:match("وضع تكرار (.*)")
database:hset(bot_id.."flooding:settings:"..msg.chat_id_ ,"floodmax" ,Num) 
send(msg.chat_id_, msg.id_,"♡∶ تم وضع عدد التكرار ("..Num..")")  
end 
if text and text:match("^وضع زمن التكرار (%d+)$") and Mod(msg) then   
...
if text and text:match("^ضع صوره") and Mod(msg) and msg.reply_to_message_id_ == 0 or text and text:match("^وضع صوره") and Mod(msg) and msg.reply_to_message_id_ == 0 then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text and text:match("^مسح صلاحيه (.*)$") and Mod(msg) or text and text:match("^حذف صلاحيه (.*)$") and Mod(msg) then 
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text ==("مسح المطرودين") and Mod(msg) then    
...
if text and text:match("^(تعطيل ملف) (.*)(.lua)$") and SudoBot(msg) then
...
if text and text:match("^(تفعيل ملف) (.*)(.lua)$") and SudoBot(msg) then
...
if text == "مسح جميع الملفات" and SudoBot(msg) then
...
if text == 'تفعيل' and SudoBot(msg) then 
if msg.can_be_deleted_ == false then 
send(msg.chat_id_, msg.id_,'♡∶ البوت ليس ادمن يرجى ترقيتي !') 
return false  
end
...
if text == 'تعطيل' and SudoBot(msg) then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text == 'تفعيل' and not SudoBot(msg) and not database:get(bot_id..'Free:Add:Bots') then  
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if text =='♡∶ الثانويين .' and not SudoBot(msg) then
...
if text =='♡∶ مسح الثانويين .' and not SudoBot(msg) then
send(msg.chat_id_, msg.id_,'♡∶ هذا الامر لمطور البوت فقط')
end
...
if text == ("قائمه المكتومين العام ♡") and SudoBot(msg) then
local list = database:smembers(bot_id.."GMuted:User")
